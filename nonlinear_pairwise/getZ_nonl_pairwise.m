function Z = getZ_nonl_pairwise(M_samples, J, x, bin_centers, betas)
%getZ_nonl_pairwise Estimates the partition function of a nonlinear
%pairwise model.
...
%
% Syntax: Z = getZ_nonl_pairwise(M_samples, J, x, bin_centers, betas)
%
% Inputs:
...
%
% Required m-files: sample_nonl_pairwise.m
...
for k = 1:(length(betas) - 2)
    ...
    samples = sample_nonl_pairwise(samples, J_k, @(E)V(E, x_k), n);
