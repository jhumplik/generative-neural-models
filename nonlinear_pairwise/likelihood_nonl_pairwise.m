function neg_log_L = likelihood_nonl_pairwise(data, M_samples, J, ...
                                                    x, bin_centers, betas)
%likelihood_nonl_pairwise Estimates the likelhood of data under a nonlinear
%pairwise model.
%Partition function is estimated using annealed importance sampling. 
%See getZ_nonl_pairwise.m. 
%
% Syntax: neg_log_L = likelihood_nonl_pairwise(data, M_samples, J, ...
%                                         x, bin_centers, betas)
%
% Inputs:
%   data: Binary array of size number_of_samples x number_of_neurons.
%   M_samples: Number of AIS samples.
%   J: Coupling matrix of the nonlinear pairwise model.
...
%              model.
%
% Required m-files: getZ_nonl_pairwise.m

Z = getZ_nonl_pairwise(M_samples, J, x, bin_centers, betas);
