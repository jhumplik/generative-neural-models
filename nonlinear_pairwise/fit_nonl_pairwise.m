function out = fit_nonl_pairwise(data, in, options)
%fit_nonl_pairwise Fits nonlinear pairwise model to data. 
...
%
% Syntax: out = fit_nonl_pairwise(data, in, options)
%
% Inputs:
...
%
% Required m-files: monotone.m, DmonotoneDt.m, sample_nonl_pairwise.m,
%                   grad_descent.m
...
parfor k = 1:n_pools
    ...
    samples_batch(:,:,k) = sample_nonl_pairwise(samples, J0, V, burn_in);
end
...
samples = sample_nonl_pairwise(samples, J, V, gibbs_steps);
